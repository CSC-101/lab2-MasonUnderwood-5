def function2(a:int, b:int, c:int) -> int:
    if a > b and a > c:
        ...
        return b+c # In general, when will a call to this function evaluate this statement? b>c and b>a and c>a
    else:
        return 2*c # In general, when will a call to this function evaluate this statement? c>b and b>a and c>a
